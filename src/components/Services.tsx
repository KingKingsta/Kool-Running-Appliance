...
const features = [
    {
        title: 'Washer & Dryer',
        description: 'About Washer & Dryer',
        image: fixingWasher,
    },
    {
        title: 'Refrigerators & Ice Makers',
        description: 'About Refrigerators & Ice Makers',
        image: fixingFridge,
    },
    {
        title: 'Stove & Ovens',
        description: 'About Stove & Ovens',
        image: fixingStove,
    },
    {
        title: 'Dishwashers',
        description: 'About Dishwashers',
                    ...
                    {({ selectedIndex }) => (
                        <>
                            <div className="-mx-4 flex overflow-x-auto pb-4 sm:mx-0 sm:overflow-visible sm:pb-0 lg:col-span-5">
                                <Tab.List className="relative z-10 flex gap-y-4 whitespace-nowrap w-full lg:flex lg:flex-col lg:mx-0 lg:block lg:gap-x-0 lg:gap-y-1 lg:whitespace-normal">
