...
const variantStyles = {
  solid: {
    ...
    green: 'bg-green-600 btn-primary text-white hover:text-slate-100 hover:bg-green-500 active:bg-green-800 active:text-green-100 focus-visible:outline-green-600',
    white:
