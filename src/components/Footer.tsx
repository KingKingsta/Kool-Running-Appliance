    ...
    return (
        <footer className="bg-slate-50">
            <div className="container">
                <div className="py-16">
                    <LogoMedium className="mx-auto h-10 w-auto" />
                ...
                <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
                    <div className="flex gap-x-6">
                        <Link
                            ...
                            className="group"
                            aria-label="KoolRunning on Facebook"
                        >
                            <svg
                                width="24"
                                height="24"
                        ...
                        <Link
                            ...
                            className="group"
                            aria-label="KoolRunning on Instagram"
                        >
                            <svg
                                width="24"
                                height="24"
                    ...
                    <p className="mt-6 text-sm text-slate-500 sm:mt-0">
                        Copyright &copy; {new Date().getFullYear()} Koolrunning
